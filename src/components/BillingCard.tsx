...
const BillingCard = ({ name, description, billAmount }: BillingCardProps) => {
  ...
  <div className="space-y-3 text-left pl-10">
    ...
    <p className="text-gray-600">
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos iusto dicta exercitationem autem maiores.
    </p>
  </div>
  ...
  <div className="text-center ">
    ...
    <button className="px-3 py-2 bg-blue-100 font-semibold border-blue-800 rounded mt-3" >What are team Users?</button>
  </div>
</div>
